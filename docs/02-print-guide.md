...
Total print time is about **28 h** on a 0.4 mm nozzle. The shell pieces are 88 × 71 × 39 mm each and look great in a silk silver.
...
- **Shell pieces**: each is a convex solid with a 40 mm blunt tip edge, two wings and three inner corners. It rests on its largest face; two of the other faces lean past 45°, so enable supports touching the build plate only. The peg socket is a 10.8 mm hole that points at the core.
